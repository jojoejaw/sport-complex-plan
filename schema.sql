...
INSERT INTO `courts` (`id`, `sport_id`, `name`, `price_per_hour`) VALUES
(1, 1, 'สนามฟุตบอล A (ในร่ม)', 600.00),
(2, 1, 'สนามฟุตบอล B (กลางแจ้ง)', 400.00),
(3, 2, 'สนามบาสเกตบอล 1', 300.00),
(4, 3, 'สนามแบดมินตัน คอร์ท 1', 150.00),
(5, 3, 'สนามแบดมินตัน คอร์ท 2', 150.00),
(6, 3, 'สนามแบดมินตัน คอร์ท 3', 150.00),
(7, 3, 'สนามแบดมินตัน คอร์ท 4', 150.00),
(8, 4, 'สนามวอลเลย์บอล 1', 250.00)
ON DUPLICATE KEY UPDATE `name`=`name`;

-- Insert Default Users (Admin: admin / admin1234, Customer: customer / customer1234)
INSERT INTO `users` (`username`, `email`, `password`, `role`) VALUES
('admin', 'admin@sportcomplex.com', '$2b$10$.Dzmg2mAjQdsjbws9xikTOmse1YEN7MGhFyJ7NQ9VFg0VnQ7zvx82', 'admin'),
('customer', 'customer@sportcomplex.com', '$2b$10$P2liKxhnMrkfjn60Q.JKwOIcO7dIxCLCnlIOkLfdn6ypLfu5e/wCu', 'customer')
